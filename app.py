...
job_required_skills = {
    ...
    "Software Engineer": ["Java", "C++", "Git", "Software Development", "Algorithms"],
    "Project Manager": ["Project Management", "Communication", "Agile Methodology", "Scrum"],
    "Business Analyst": ["Data Analysis", "SQL", "Business Intelligence", "Excel"],

    # NEW:
    "Backend Developer": ["Python", "Java", "Node.js", "SQL", "MongoDB", "APIs", "Django", "Flask"]
}
...
def calculate_skills_match(extracted_skills, job_category):
    # Normalize job_category if alias exists
    if job_category in label_aliases:
        job_category = label_aliases[job_category]

    required_skills = job_required_skills.get(job_category, [])
...
def pred():
    ...
    if 'resume' in request.files:
        ...
        skills_match_score, matched_skills, missing_skills = calculate_skills_match(
            extracted_skills,
            recommended_job   # you can switch to predicted_category if preferred
        )
